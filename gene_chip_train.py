...
def main(argv=None):
    ...
    #data_disease_list_bool = sio.loadmat('disease_list_bool_mat')
    ...
    #data_gene_chip_reduction = sio.loadmat('gene_chip_reduction_norm')
    ...
    print(numpy.size(gene.train.data, 1))
    print(numpy.size(gene.train.labels, 0))
    print(numpy.size(gene.train.labels, 1))
    print(gene.train.data.dtype)
    print(gene.train.labels.dtype)
    train(gene)
